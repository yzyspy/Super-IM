...
type GroupModel struct {
	models.Model
	Title                string                      `gorm:"column:title;size:255" json:"title"`       //群名称
	Abstract             string                      `gorm:"column:abstract;size:255" json:"abstract"` //群描述
	Avatar               string                      `gorm:"column:avatar;size:255" json:"avatar"`     //群头像
